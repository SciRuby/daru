    ...
    context "#from_html" do
      context "in wiki info table" do
        ...
        context "returns user-modified dataframe" do
          subject { Daru::DataFrame.from_html(path, order: order, index: index) }
      ...
      context "in wiki climate data" do
        ...
        context "returns default dataframe" do
          ...
          it { is_expected.to be_an(Array).and all be_a(Daru::DataFrame) }
          its('first.index') { is_expected.to eq(Daru::Index.new(["Record high °C (°F)", "Average high °C (°F)", "Daily mean °C (°F)", "Average low °C (°F)", "Record low °C (°F)", "Average rainfall mm (inches)", "Average rainy days", "Average relative humidity (%)", "Mean monthly sunshine hours", "Mean daily sunshine hours"]
              )
            )
          }     
        end
      ...
      context "with valid html table markups" do
        ...
        context "returns user-modified dataframe" do
          subject { Daru::DataFrame.from_html(path, index: index) }
      ...
      context "in share market data" do
        ...
        context "returns user-modified matching dataframes" do
          subject { Daru::DataFrame.from_html(path, match: match, index: index) }
